...
const AboutMeText = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center md:text-left w-full mt-[0px]">
      <h2 className="text-4xl sm:text-5xl md:text-6xl text-mutedGold mb-8 md:mb-10">About Me</h2>
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full">
        ...
        <div className="bg-richBlackGreen p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-500 text-ivory w-full md:w-1/3 mb-6 md:mb-0">
          <p className="font-normal text-sm sm:text-base text-justify mb-2">
        ...
        {/* Education Section */}
        <div className="bg-richBlackGreen p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-500 text-ivory w-full md:w-1/3 mb-6 md:mb-0">
          <p className="text-xl md:text-2xl text-mutedGold text-center mb-2">Education</p>
        ...
        <div className="bg-richBlackGreen p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-500 text-ivory w-full md:w-1/3">
          ...
          <div className="flex items-center justify-center md:justify-start">
            <p className="font-normal text-sm sm:text-base text-justify mb-2">
              Each certification marks a step in my journey of learning, growth, and commitment to excellence.
            </p>
          </div>
          <div className="flex items-center justify-center md:justify-start">
      ...
      <div className="w-full flex justify-center md:justify-start">
        <button className="border border-richMetallicGold rounded-3xl py-2 px-6 text-base md:text-lg mt-6 hover:bg-warmOliveTint transition-all duration-500 cursor-pointer text-softSage hover:text-deepForestGreen hover:font-semibold"
