...
const project = [
  {
    name: "MEMONEST",
    about:
  "A full-stack notes management application with CRUD functionality, responsive UI, and light/dark theme support, built using the MERN stack.",
technologies:
  "React | Node.js | Express.js | MongoDB | Tailwind CSS | Git",
    year: "December 2025",
    align: "right",
