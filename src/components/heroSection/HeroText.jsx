...
const HeroText = () => {
  ...
  return (
    <div className="flex flex-col gap-4 h-full justify-center md:text-left sm:text-center">
        <h3 className="text-4xl font-special font-light text-warmOliveTint">Hi There,</h3>
        <h1 className="md:text-[2.8rem] lg:text-6xl sm:text-4xl font-bold font-special text-warmOliveTint">I'm Pramodi Dewindi</h1>
        <motion.h2 
        key={index} 
